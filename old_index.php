<!DOCTYPE html>
    ...
    <body>
        <div id="container">
            <div id="info">
                <div id="social">
                    <a href="index.php"><img id="logo" src="http://placekitten.com/500/500"></a>
                ...
                <div id='options_mobile' class='clearfix hidden'></div>
            ...
            <div id="options">
                <div id="desc">
                    <p>Bryce Williams is a video game designer and teacher, working primarily in C#. He works in primarily Unity3D, but nearly any project or idea is pretty interesting. Doubly so if you mention the word "SEGA" in there.</p>
                </div>
                <div id="sitepic">
                    <img src="http://placekitten.com/1904/2539">
                </div>
            </div>
            <div id="projDisplay" class="hidden">
                <div id="projName"><h1>Project Name</h1></div>
                <div id="projRole"><h3>Project Role</h3></div>
                <div id="projTool"><h3>Project Tools</h3></div>
                <div id="projDesc"><p>Text text text text text.</p></div>
                <div id="projGallery"><img src="http://placekitten.com/1920/1080"></div>
            </div>
        </div>
